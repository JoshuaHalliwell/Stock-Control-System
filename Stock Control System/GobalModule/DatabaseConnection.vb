Module DatabaseConnection
    ...
    Public con As New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Environment.ExpandEnvironmentVariables("%USERPROFILE%") & "\source\repos\Stock-Control-System\Stock Control System\StockDataBase.accdb") 'Useing a pre- defined Library to connect to the database'   & Application.StartupPath &
